...
public class ProductServiceImpl implements ProductService {
   ...
   /**
    * @see org.diveintojee.poc.ehcache.spring.domain.services.ProductService#list()
    */
   @Override
   ...
   /**
    * @see org.diveintojee.poc.ehcache.spring.domain.services.ProductService#findByDescription(java.lang.String)
    */
   @Override
   ...
   /**
    * @see org.diveintojee.poc.ehcache.spring.domain.services.ProductService#add(org.diveintojee.poc.ehcache.spring.domain.Product)
    */
   @Override
   ...
   /**
    * @see org.diveintojee.poc.ehcache.spring.domain.services.ProductService#update(org.diveintojee.poc.ehcache.spring.domain.Product)
    */
   @Override
   ...
   /**
    * @see org.diveintojee.poc.ehcache.spring.domain.services.ProductService#get(java.lang.Long)
    */
   @Override
   ...
   /**
    * @see org.diveintojee.poc.ehcache.spring.domain.services.ProductService#delete(java.lang.Long)
    */
   @Override
   ...
   /**
    * @see org.diveintojee.poc.ehcache.spring.domain.services.ProductService#clear()
    */
   @Override
   public void clear() {
